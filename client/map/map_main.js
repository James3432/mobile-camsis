	...
	if((startup != true) && (zoom != this.map.getZoom())){
		...
		if(this.map.getZoom() == 3){
			...
			if((x_shift == null)&&(y_shift == null)){
				...
				if(dir == "in"){
					...
					x = 8*(15/24)*x_shift + 0;
					y = -8*(12/19)*y_shift - 10;
					
					loc_x = 2*(15/24)*(loc_x + 0);
					loc_y = 2*(12/19)*(loc_y + 7);
		...
		if(this.map.getZoom() == 4){
			...
			if((x_shift == null)&&(y_shift == null)){
				...
				x = 4*(24/15)*x_shift - 0;
				y = -4*(19/12)*y_shift + 50;
				
				loc_x = 0.5*(24/15)*loc_x - 0;
				loc_y = 0.5*(19/12)*loc_y - 7;
